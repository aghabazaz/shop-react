                  ...
                  <div className="row">
                     <div className="col-md-4">
                        <ul className="conta_icon ">
                           <li><a href="#"><img src={call} alt="#"/>Call us: 0126 - 922 - 0162</a> </li>
                        </ul>
                     </div>
                     <div className="col-md-4">
                        <ul className="social_icon">
                           ...
                           <li> <NavLink  to="/about"><i className="fa fa-twitter"></i></NavLink></li>
                        ...
                        <div className="se_fonr1">
                           <form action="#" >
                              <div className="select-box">
                                 <label className="label select-box1"><span className="label-desc">English</span> </label>
                  ...
                  <div className="row d_flex">
                     <div className="col-md-4">
                        <ul className="conta_icon d_none1">
                           <li><a href="#"><img src={email} alt="#"/> demo@gmail.com</a> </li>
                        </ul>
                     </div>
                     <div className="col-md-4">
